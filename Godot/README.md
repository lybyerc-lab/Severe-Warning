...
A Godot 4.7 (Mobile preset) scaffold — `project.godot`, `scenes/main.tscn` and
`scripts/main.gd` — from the same engine evaluation that produced the Unity
slice in `Assets/SevereWeather/`. It never progressed past a scaffold.

Last functional change: `be1d4e6` (2026-08-04).

Background: `Docs/GODOT_MIGRATION_CHECKPOINT_2026-07-30.md`.
