...
// safe and slapstick, but bound each orbit by monotonic wall time and require
// the storm to move away before that cow can be armed for another launch.
// ============================================================================
...
if (changed) {
  ...
  console.log('Prepared same-origin PlayCanvas gameplay authority bundle with wall-time-bounded Cow 17 orbit.');
} else {
