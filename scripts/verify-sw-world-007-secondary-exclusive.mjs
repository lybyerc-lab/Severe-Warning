...
check('Supercell/Derecho read the existing currentStorm presentation truth', runtime.includes("typeof currentStorm !== 'undefined'") && runtime.includes('return currentStorm'));
check('state telemetry is only a bounded fallback for active storm read', runtime.includes('getSwWorld007State') && runtime.includes('activeStorm'));
