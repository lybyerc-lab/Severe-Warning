...
check('touchdown initializes and reuses the WORLD-002 production storm silhouette', integration.includes("getObjectByName?.(rootName)") && integration.includes('refreshHeroSlice6?.()') && integration.includes('swVisualHeroSlice6BuildStormSilhouette()') && integration.includes('productionStorm.clone(true)') && integration.includes("profile: 'world-slice6-asymmetric-storm-v2'"));
