...
requireText(bootstrapHelper, "matcher: 'code_execution'", 'bootstrap helper');
rejectText(bootstrapHelper, "matcher: '.*'", 'bootstrap helper');
...
console.log('- command gate: code_execution only; exact initial/correction scripts plus tiny read-only Git checks');
