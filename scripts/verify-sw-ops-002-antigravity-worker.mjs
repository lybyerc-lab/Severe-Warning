...
console.log('- sandbox Git state is untrusted and not authoritative');
console.log('- host extracts only allowlisted files and builds the patch on the frozen base');
console.log('- GitHub credentials are not persisted or sent to Antigravity');
console.log('- obsolete bootstrap/V2/V3 proof machinery is absent');
