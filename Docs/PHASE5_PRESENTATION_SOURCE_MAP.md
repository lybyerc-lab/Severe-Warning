...
**Source Baseline:** `MechanicsLab/SevereWeather_3D_Lab.html` (Unchanged in branch diff)

---

## 1. Provenance & Clean Source Law

- `MechanicsLab/SevereWeather_3D_Lab.html` is the unpatched historical source baseline.
- `git diff --exit-code origin/agent/phase4-knowledge-antigravity-handoff -- MechanicsLab/SevereWeather_3D_Lab.html` MUST pass before every build and QA execution.
...
- **Source Region**: `[SW:SOURCE:v510-foundation.js]` in `MechanicsLab/SevereWeather_3D_Lab.html`
...
- **Source Region**: `[SW:SOURCE:v510-tornado.js]` in `MechanicsLab/SevereWeather_3D_Lab.html`
...
- **Source Region**: `[SW:SOURCE:v510-world.js]` in `MechanicsLab/SevereWeather_3D_Lab.html`
...
- **Source Region**: `[SW:SOURCE:v510-world.js]` in `MechanicsLab/SevereWeather_3D_Lab.html` / `v510-runtime.js`
- **Stage Language**:
