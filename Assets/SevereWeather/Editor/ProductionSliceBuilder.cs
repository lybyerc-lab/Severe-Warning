...
namespace SevereWeather.Editor
{
    public static class ProductionSliceBuilder
    {
        ...
        public static void CreateProductionSliceScene()
        {
            ...
            Debug.Log($"[Severe Weather] Build #4 production slice created at {ScenePath}");
        }
        ...
        private static void ConfigureBuildIdentityAndMaterials()
        {
            ...
            CreateMaterialAsset(
                GeneratedResourcesDirectory + "/RuntimeWorldUrpLit.mat",
                FindOptionalShader("Universal Render Pipeline/Lit", "SevereWeather/RuntimeColor"));
            CreateMaterialAsset(
                GeneratedResourcesDirectory + "/RuntimeUnlit.mat",
                FindRequiredShader("Sprites/Default", "Unlit/Color", "SevereWeather/RuntimeColor"));
            CreateMaterialAsset(
                GeneratedResourcesDirectory + "/RuntimeUrpUnlit.mat",
                FindOptionalShader("Universal Render Pipeline/Unlit", "Sprites/Default", "SevereWeather/RuntimeColor"));
            ...
            if (string.IsNullOrWhiteSpace(cloudBuildNumber)) cloudBuildNumber = "4";
        ...
        public static void ValidateProductionStarter()
        {
            ...
            {
                EditorUtility.DisplayDialog("Severe Weather Validation", message + "\nBuild #4 structure is ready for device testing.", "OK");
                Debug.Log(message);
            }
        }
    }
