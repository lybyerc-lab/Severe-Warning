...
namespace SevereWeather.Editor
{
    public static class ProductionSliceBuilder
    {
        ...
        private const int AndroidVersionCode = 10;
        ...
        public static void CreateProductionSliceScene()
        {
            ...
            Debug.Log($"[Severe Weather] Tornado Tactical P1 production slice created at {ScenePath}");
        }
        ...
        private static void ConfigureBuildIdentityAndMaterials()
        {
            ...
            if (string.IsNullOrWhiteSpace(cloudBuildNumber)) cloudBuildNumber = "Tornado Tactical P1";
        ...
        public static void ValidateProductionStarter()
        {
            ...
            {
                EditorUtility.DisplayDialog("Severe Weather Validation", message + "\nTornado Tactical P1 structure is ready for device testing.", "OK");
                Debug.Log(message);
            }
        }
    }
